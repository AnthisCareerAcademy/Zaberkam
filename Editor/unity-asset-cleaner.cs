...
public class AssetCleaner : EditorWindow
{
    ...
    private SortedDictionary<string, bool> assetsToDelete;
    private Dictionary<string, bool> scenesToInclude;
    ...
    private void RefreshSceneList()
    {
        ...
        // Search for all scenes in project
    ...
    private void OnGUI()
    {
        ...
        if (sceneFoldout)
        {
            ...
            scrollPositionTop = EditorGUILayout.BeginScrollView(scrollPositionTop, GUILayout.Height(200));
    ...
    private void FindUnusedAssets()
    {
        ...
        // Protect the script from deletion
